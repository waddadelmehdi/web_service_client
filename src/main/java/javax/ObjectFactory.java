...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://ws.wem.ma/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.wem.ma/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://ws.wem.ma/", "compte");
    private static final QName _GetCompte_QNAME = new QName("http://ws.wem.ma/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.wem.ma/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.wem.ma/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.wem.ma/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.wem.ma/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.wem.ma/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.wem.ma/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.wem.ma/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.wem.ma/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.wem.ma/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.wem.ma/", name = "listComptesResponse")
