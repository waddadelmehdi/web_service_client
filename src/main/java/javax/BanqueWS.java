 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.wem.ma/", wsdlLocation = "http://localhost:9090/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.wem.ma/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.wem.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.wem.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
